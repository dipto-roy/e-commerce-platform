  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8">
      ...
      <div className="w-full max-w-lg p-8 space-y-6 bg-gray-800 rounded-xl shadow-lg">
        ...
        {/* OAuth2 Google Sign-In - Only for regular users */}
        {formData.role === "user" ? (
          <>
            {/* Divider */}
          ...
          /* Info message for sellers */
          <div className="bg-blue-500/20 border border-blue-500 text-blue-200 px-4 py-3 rounded text-sm">
            <strong>Note:</strong> Seller accounts require admin approval and cannot use Google sign-in. Please use the form above to register.
          </div>
        )}
